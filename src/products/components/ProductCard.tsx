        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex">
            ...
            <button
              ...
              className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:hover:bg-red-700 ">
